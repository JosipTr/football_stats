...
void showAddTrainingDialog(BuildContext context, Player player) {
  showDialog(
      context: context,
      builder: (context) {
        late String training;
        return AlertDialog(
          title: const Text('Unesi broj treninga'),
          actions: [
              ...
              TextField(
                ...
                onChanged: (value) => training = value,
              ),
          Row(
            ...
            TextButton(
                onPressed: () {
                  try {
                    player.trainingDays = int.parse(training);
