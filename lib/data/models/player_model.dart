...
class Player {
  ...
  String getMatchesEfficiency() {
    ...
    String getAssistsPerMatch() {
    if (assists == 0 || assists == null || matchesPlayed == 0 || matchesPlayed == null) {
      return '0';
    }
    return (assists!/matchesPlayed!).toStringAsFixed(2);
  }

    String getAssistsEfficiency() {
    if (assists == 0 || assists == null || matchesPlayed == 0 || matchesPlayed == null) {
      return '0';
    }
    return ((assists!/matchesPlayed!) * 100).toStringAsFixed(2);
  }
}
